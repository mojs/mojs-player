...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('../class-proto'), require('./tweenie-defaults'), require('./tweener'), require('../easing/parse-easing'), require('../helpers/stagger-property'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.classProto, global.tweenieDefaults, global.tweener, global.parseEasing, global.staggerProperty);
    global.mojs = mod.exports;
  }
})(this, function (exports) {
  'use strict';
  ...
  })(undefined, function (exports, _classProto, _tweenieDefaults, _tweener, _parseEasing, _staggerProperty) {
    'use strict';
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(2), __webpack_require__(23), __webpack_require__(5), __webpack_require__(18), __webpack_require__(3), __webpack_require__(1), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../tween/tweenie'), require('../tween/timeline'), require('../tween/tweenable'), require('./delta'), require('./separate-tweenie-options'), require('../helpers/stagger-property'), require('./motion-path'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.tweenie, global.timeline, global.tweenable, global.delta, global.separateTweenieOptions, global.staggerProperty, global.motionPath);
    global.mojs = mod.exports;
  }
})(this, function (exports) {
  'use strict';
  ...
  (function (global, factory) {
  ...
  })(undefined, function (exports, _tweenie, _timeline, _tweenable, _delta, _separateTweenieOptions, _staggerProperty, _motionPath) {
    'use strict';
    ...
    Deltas._setupTweenie = function (options) {
      ...
      // create tween
      this.tween = new _tweenie.Tweenie(_extends({}, tweenieOptions, {
    ...
    Deltas._parseProperties = function (options) {
      ...
      for (var key in options) {
        ...
        if (typeof value !== 'object') {
          ...
          this._staticProps[key] = (0, _staggerProperty.staggerProperty)(value, this.index);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('../tween/tweenie'), require('../class-proto'), require('./separate-tweenie-options'), require('../helpers/stagger-property'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.tweenie, global.classProto, global.separateTweenieOptions, global.staggerProperty);
    global.mojs = mod.exports;
  }
})(this, function (exports) {
  'use strict';
  ...
  (function (global, factory) {
  ...
  })(undefined, function (exports, _tweenie, _classProto, _separateTweenieOptions, _staggerProperty) {
    'use strict';
    ...
    MotionPath._setupTweenie = function () {
      ...
      var tweenOptions = (0, _separateTweenieOptions.separateTweenieOptions)(options);
      if (tweenOptions !== undefined) {
        this.tween = new _tweenie.Tweenie(_extends({}, tweenOptions, {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('../class-proto'), require('../tween/tweenie'), require('./split-delta'), require('./parse-number'), require('./parse-unit'), require('./parse-color'), require('./unit-regexp'), require('../helpers/stagger-property'), require('../helpers/make-color-object'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.classProto, global.tweenie, global.splitDelta, global.parseNumber, global.parseUnit, global.parseColor, global.unitRegexp, global.staggerProperty, global.makeColorObject);
    global.mojs = mod.exports;
  }
})(this, function (exports) {
  'use strict';
  ...
  (function (global, factory) {
  ...
  })(undefined, function (exports, _classProto, _tweenie, _splitDelta, _parseNumber, _parseUnit, _parseColor, _unitRegexp, _staggerProperty, _makeColorObject) {
    'use strict';
    ...
    */
    ...
    Delta._setupTweenie = function () {
      ...
      this.tween = new _tweenie.Tweenie(_extends({
        index: this.index
      }, tweenieOptions, {
        // send `onUpdate` function to call the `this.update` function
        // and envoke previous `onUpdate`
  ...
  (function (global, factory) {
    ...
    Timeline.add = function (tweenie) {
      ...
      if (tweenie instanceof Array) {
        ...
        var runner = tweenie.timeline || tweenie.tween;
        if (runner) {
          tweenie = runner;
        }
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(5), __webpack_require__(8), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./tween/tweenable'), require('./delta/deltas'), require('./class-proto'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.tweenable, global.deltas, global.classProto);
    global.mojs = mod.exports;
  }
})(this, function (exports) {
  'use strict';
  ...
  (function (global, factory) {
  ...
  })(undefined, function (exports, _tweenable, _deltas, _classProto) {
    'use strict';
    ...
    */
    ...
    Html._getCustomProperties = function () {
      ...
      customProps.pipeObj = this._isRender() ? originalRender : void 0;
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(0), __webpack_require__(2), __webpack_require__(4), __webpack_require__(23), __webpack_require__(17), __webpack_require__(14), __webpack_require__(6), __webpack_require__(18), __webpack_require__(22), __webpack_require__(21), __webpack_require__(20), __webpack_require__(19), __webpack_require__(3), __webpack_require__(5), __webpack_require__(1), __webpack_require__(10), __webpack_require__(7), __webpack_require__(27), __webpack_require__(8), __webpack_require__(9), __webpack_require__(26), __webpack_require__(24)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./class-proto'), require('./tween/tweenie'), require('./tween/tweenie-defaults'), require('./tween/timeline'), require('./tween/tweener'), require('./easing/easing'), require('./easing/parse-easing'), require('./delta/delta'), require('./delta/split-delta'), require('./delta/parse-number'), require('./delta/parse-unit'), require('./delta/parse-color'), require('./delta/separate-tweenie-options'), require('./tween/tweenable'), require('./helpers/stagger-property'), require('./helpers/parse-stagger'), require('./helpers/make-color-object'), require('./easing/basic-easing'), require('./delta/deltas'), require('./delta/motion-path'), require('./stagger'), require('./html'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.classProto, global.tweenie, global.tweenieDefaults, global.timeline, global.tweener, global.easing, global.parseEasing, global.delta, global.splitDelta, global.parseNumber, global.parseUnit, global.parseColor, global.separateTweenieOptions, global.tweenable, global.staggerProperty, global.parseStagger, global.makeColorObject, global.basicEasing, global.deltas, global.motionPath, global.stagger, global.html);
    global.mojs = mod.exports;
  }
  ...
  })(undefined, function (module, exports, _classProto, _tweenie, _tweenieDefaults, _timeline, _tweener, _easing, _parseEasing, _delta, _splitDelta, _parseNumber, _parseUnit, _parseColor, _separateTweenieOptions, _tweenable, _staggerProperty, _parseStagger, _makeColorObject, _basicEasing, _deltas, _motionPath, _stagger, _html) {
    'use strict';
